...
-(void)initFenShiChart
{
    ...
    [self.fenshiChart getYAxis:0 withIndex:0].tickInterval = 6; //设置虚线数量
   
    self.fenshiChart.range = 20; //设置显示区间大小
    ...
    [serie setObject:@"收盘价" forKey:@"label"]; //当选中时，Label 要显示的名称
    ...
    [serie setObject:@"收盘价" forKey:@"label"];
...
- (void)renderChart:(NSDictionary *)responseObject
{
    ...
    NSArray *listArray = responseObject[@"newList"];   //解析数据
